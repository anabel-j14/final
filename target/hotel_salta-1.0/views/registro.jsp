<%-- 
    Document   : registro
    Created on : 27/12/2022, 17:13:39
    Author     : FIX
--%>
...
<main class="container d-flex justify-content-center align-items-center">
    ...
    <form method="POST" action="/hotel_salta/usuario/createUser" class="w-50 px-5 py-4 rounded" >
        ...
        <div class="row align-items-center justify-content-between">
            ...
            <div class="col-auto">
                <a href="/hotel_salta" class="link-primary">Inicio</a>
            </div>
        </div>
    </form>
</main>
