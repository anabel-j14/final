<%-- 
    Document   : edicion
    Created on : 30/12/2022, 19:55:02
    Author     : FIX
--%>
...
<%
    if (!(boolean)session.getAttribute("isLogin")){
        response.sendRedirect("/hotel_salta/");
    }
...
<main class="container d-flex justify-content-center align-items-center">
    ...
    <form method="POST" action="/hotel_salta/usuario/updateUser" class="w-50 px-5 py-4 rounded" >
        ...
        <div class="row align-items-center justify-content-between">
            ...
            <div class="col-auto">
                <a href="/hotel_salta/usuario/deleteUser" class="btn btn-danger">Eliminar</a>
            </div>
            <div class="col-auto">
                <a href="/hotel_salta"  class="btn btn-primary" >Inicio</a>
            </div>
        </div>
    </form>
</main>
