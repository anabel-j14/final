<%-- 
    Document   : login
    Created on : 27/12/2022, 17:13:06
    Author     : FIX
--%>
...
<main class="container d-flex justify-content-center align-items-center">
    ...
    <form method="POST" action="/hotel_salta/usuario/loginUser" class="py-4 px-5 rounded" >
        ...
        <div class="row align-items-center justify-content-between">
            ...
            <div class="col-auto">
                <a href="/hotel_salta/views/registro.jsp" class="link-primary">Registrarme</a>
            </div>
        </div>
    </form>
</main>
