        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            switch (action) {
                case "/loginUser":
                    ...
                    response.sendRedirect("/hotel_salta/views/user.jsp");
                    break;
                ...
                case "/createUser":
                    ...
                    response.sendRedirect("/hotel_salta/views/userCreado.jsp");
                    break;
                ...
                case "/viewUser":
                    ...
                    response.sendRedirect("/hotel_salta/views/edicion.jsp");
                    break;
